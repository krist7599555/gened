...
export const BUILDING = {
  ...
  CHMSQ: "จัตุรัสจามจุรี ชั้น 14 ธุรกิจเทคโนโลยีและการจัดการนวัตกรรม CHAMCHURI SQUARE F14 TIP",
  CHOL: "โรงพยาบาลชลบุรี CHOLBURI HOSPITAL",
  CHOM1: "ชมพูภูคา1 CHOMPOOPHUKA1",
  CHONG: "ตึกจงกลณี CHONGKOLNEE",
  CHUHO: "โรงพยาบาลจุฬาภรณ์ (ศูนย์โรคลมชัก สถาบันวิจัยจุฬาภรณ์) CHULABHORN HOSPITAL",
  ...
  CUSC: "ศูนย์กีฬาแห่งจุฬาลงกรณ์มหาวิทยาลัย CHULALONGKORN UNIVERSITY SPORTS CENTER",
  CUSCS: "สระว่ายน้ำ ศูนย์กีฬาแห่งจุฬาลงกรณ์มหาวิทยาลัย CU SPORTCENTER SWIMMIN POOL",
  CUSCT: "สนามเทนนิส ศูนย์กีฬาแห่งจุฬาลงกรณ์มหาวิทยาลัย CU SPORTSCENTER TENNIS COURT",
  ...
  EDU2: "ตึก 2 (อาคารพระมิ่งขวัญการศึกษาไทย) EDUCATION 2 (PHARMINGKHWANKARNSUKSATHAI)",
  ...
  HANS: "ตึกภาควิชาวิศวกรรมเครื่องกล (ฮันส์ บันตสิ) MECHANICAL ENGINEERING (HANS BUILDING)",
  ...
  IN2ER: "อาคารสถาบัน 2, สถาบันวิจัยสภาวะแวดล้อม INSTITUTE 2, ENVIRONMENTAL RESEARCH INSTITUTE",
  INST2:
  ...
  KKKKK: "kk KK",
  KUMKL: "อาคารคุ้มเกล้า โรงพยาบาลภูมิพล กรมการแพทย์ทหารอากา KUMKLAO, PHUMIPHOL HOSPITAL",
  ...
  MNBLD: "ตึกภาควิชาวิศวกรรมเหมืองแร่และปิโตรเลียม MINING AND PETROLEUM ENGINEERING",
  ...
  OSOT: "สถานปฎิบัติการเภสัชกรรมชุมชน(โอสถศาลา) COMMUNITY PHARMACY LABORATORY (OSOTSARA) BLD.",
  ...
  PREML: "อาคารเปรมบุรฉัตร(สถาบันภาษา) PREM PURACHATRA BUILDING(LANGUAGE INSTUTUTE)",
  PREMP: "อาคารเปรมบุรฉัตร PREM PURACHATRA BUILDING",
  PREVM: "ตึกภาควิชาเวชศาสตร์ป้องกันและสังคม DEPARTMENT OF PREVENTIVE AND SOCIAL MEDICINE",
  PSY: "บรมราชชนนีศรีศตพรรษ BOROMMARATCHACHONNANISRISATTAPAT",
  PTUM5: "อาคาร 5 มหาวิทยาลัยศรีนครินทรวิโรฒ PTUM 5, SRI NAKHARINWIROT UNIVERSITY",
  ...
  SALAB: "ตึกภาควิชาวิศวกรรมเครื่องกล (สลับ ลดาวัลย์) MECHANICAL BUILDING (SALAB LADAWAN)",
  ...
  VIDF5: "วิทยพัฒนา ชั้น 5 บัณฑิตวิทยาลัย VIDHAYAPATTANA BUILDING F5 GRADUATE SCHOOL",
